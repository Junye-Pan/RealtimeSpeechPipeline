...
verify-quick:
	VERIFY_QUICK_CMD='go run ./cmd/rspp-cli validate-spec pipelines/specs/voice_assistant_spec_v1.json strict && go run ./cmd/rspp-cli validate-policy pipelines/policies/voice_assistant_policy_v1.json strict && go run ./cmd/rspp-cli conformance-governance-report && go run ./cmd/rspp-cli validate-contracts && go run ./cmd/rspp-cli validate-contracts-report && go run ./cmd/rspp-cli replay-smoke-report && go run ./cmd/rspp-cli generate-runtime-baseline && go run ./cmd/rspp-cli slo-gates-report && go test ./api/controlplane ./api/eventabi ./internal/runtime/planresolver ./internal/runtime/turnarbiter ./internal/runtime/executor ./internal/runtime/buffering ./internal/runtime/guard ./internal/runtime/transport ./internal/observability/replay ./internal/observability/timeline ./internal/observability/telemetry ./internal/tooling/conformance ./internal/tooling/regression ./internal/tooling/ops ./internal/tooling/release ./transports/livekit ./test/contract ./test/integration ./test/replay && go test ./test/failover -run '\''TestF[137]'\''' bash scripts/verify.sh quick

verify-full:
	VERIFY_FULL_CMD='go run ./cmd/rspp-cli validate-spec pipelines/specs/voice_assistant_spec_v1.json strict && go run ./cmd/rspp-cli validate-policy pipelines/policies/voice_assistant_policy_v1.json strict && go run ./cmd/rspp-cli conformance-governance-report && go run ./cmd/rspp-cli validate-contracts && go run ./cmd/rspp-cli validate-contracts-report && go run ./cmd/rspp-cli replay-regression-report && go run ./cmd/rspp-cli generate-runtime-baseline && go run ./cmd/rspp-cli slo-gates-report && go test ./...' bash scripts/verify.sh full

verify-mvp:
	VERIFY_MVP_CMD='bash scripts/prepare-mvp-live-artifacts.sh && go run ./cmd/rspp-cli validate-spec pipelines/specs/voice_assistant_spec_v1.json strict && go run ./cmd/rspp-cli validate-policy pipelines/policies/voice_assistant_policy_v1.json strict && go run ./cmd/rspp-cli conformance-governance-report && go run ./cmd/rspp-cli validate-contracts && go run ./cmd/rspp-cli validate-contracts-report && go run ./cmd/rspp-cli replay-regression-report && go run ./cmd/rspp-cli generate-runtime-baseline && go run ./cmd/rspp-cli slo-gates-report && go run ./cmd/rspp-cli live-latency-compare-report && go run ./cmd/rspp-cli slo-gates-mvp-report && go test ./...' bash scripts/verify.sh mvp
